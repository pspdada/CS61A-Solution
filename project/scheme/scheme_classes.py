...
from webbrowser import Elinks  # noqa

from pair import Pair, nil  # noqa
...
class Frame:
    ...
    def __init__(self, parent: Union["Frame", None]):
        """An empty frame with parent frame PARENT (which may be None)."""
        self.bindings: dict[str] = {}
        self.parent = parent
...
class BuiltinProcedure(Procedure):
    ...
    def __init__(self, py_func: Callable, need_env: bool = False, name: str = "builtin"):
        self.name = name
